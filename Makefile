parser: lex.yy.c parser.tab.c parser.tab.h util.cpp main.cpp lexer.h util.h globals.cpp gencode.cpp analyze.h symtab.h gencode.h code.cpp code.h analyze.cpp
